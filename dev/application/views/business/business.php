<div class="subpage container clearfix">
	<div class="page-content floatright category">
		...
		<p><span class="bold large"><i class="fa fa-check"></i> <a href="<?php echo base_url('business/payroll'); ?>">Payroll</a></span> - Allow us to help you with your payroll needs; from processing payroll checks to filing the required payroll tax returns. </p>
		...
		<p><span class="bold large"><i class="fa fa-check"></i> <a href="<?php echo base_url('business/irs_help'); ?>">IRS Help</a></span> - As Enrolled Agents, we can represent you during any kind of audit from the IRS.</p>
	</div><!--/ .page-content -->
